...
export const SinglePostCard = ({post}: { post: PostEntity }) => {
    ...
    return (
        <article
            className="w-80 h-80 border border-gray-300 rounded-br-3xl overflow-hidden shadow-lg flex flex-wrap bg-white dark:border-neutral-800 dark:shadow-neutral-500 dark:shadow-md">
